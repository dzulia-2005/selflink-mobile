...
export type Theme = {
  ...
  gradients: {
    ...
    matrix: readonly [string, string, ...string[]];
    nebulaPurple: readonly [string, string, ...string[]];
    cosmicBlue: readonly [string, string, ...string[]];
    matrixGlow: readonly [string, string, ...string[]];
    soulPink: readonly [string, string, ...string[]];
    mentorGold: readonly [string, string, ...string[]];
    button: readonly [string, string, ...string[]];
    buttonActive: readonly [string, string, ...string[]];
    buttonDisabled: readonly [string, string, ...string[]];
    panel: readonly [string, string, ...string[]];
    messagingBackground: readonly [string, string, ...string[]];
    messagingOutgoing: readonly [string, string, ...string[]];
    messagingIncoming: readonly [string, string, ...string[]];
  };
